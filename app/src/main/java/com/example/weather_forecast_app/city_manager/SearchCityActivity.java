package com.example.weather_forecast_app.city_manager;
...
import com.example.weather_forecast_app.base.BaseActivity;
...
//                      判断是否能够找到这个城市
    ...
    public void onSuccess(String result) {
        ...
        if (weatherBean.getError_code()==0) {//说明这个城市是存在的
